      ...
      <div class="sm:flex items-center max-w-screen-xl">
        <div class="sm:w-1/2 p-10">
          <div class="image object-center text-center">
            <p class="text-base font-semibold leading-6 text-green-400 uppercase">Online Downloader</p>
            <h4 class="mt-2 text-2xl font-extrabold leading-8 text-gray-900 dark:text-white sm:text-3xl sm:leading-9">Frequently Asked Questions</h4>
            ...
            <ul class="mt-8 space-y-3 font-medium">
              <li class="flex items-start lg:col-span-1">
                ...
                <p class="ml-3 leading-5 text-gray-600">What is Downloader and why do you need it?</p>
              </li>
              <li class="flex items-start lg:col-span-1">
                <div class="flex-shrink-0">
                  <svg class="w-5 h-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p class="ml-3 leading-5 text-gray-600">How to install the extension to Google Chrome?</p>
              </li>
              <li class="flex items-start lg:col-span-1">
                <div class="flex-shrink-0">
                  <svg class="w-5 h-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p class="ml-3 leading-5 text-gray-600">Where are the downloaded files stored?</p>
              </li>
              <li class="flex items-start lg:col-span-1">
                <div class="flex-shrink-0">
                  <svg class="w-5 h-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
